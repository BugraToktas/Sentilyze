...
export interface ApiAnalysisItemAnalysisItem
  extends Struct.CollectionTypeSchema {
  collectionName: 'analysis_items';
  info: {
    displayName: 'Analysis Item';
    pluralName: 'analysis-items';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sentiment_label: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiAnalysisJobAnalysisJob extends Struct.CollectionTypeSchema {
  collectionName: 'analysis_jobs';
  info: {
    displayName: 'Analysis Job';
    pluralName: 'analysis-jobs';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    emotions_summary: Schema.Attribute.JSON;
    job_status: Schema.Attribute.String;
    job_type: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::analysis-job.analysis-job'
    > &
      Schema.Attribute.Private;
    negative_count: Schema.Attribute.Integer;
    neutral_count: Schema.Attribute.Integer;
    positive_count: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    total_analyzed: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::analysis-item.analysis-item': ApiAnalysisItemAnalysisItem;
      'api::analysis-job.analysis-job': ApiAnalysisJobAnalysisJob;
